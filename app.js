    ...
    for (i = 0; i < centros.length; i++) {
        ...
        switch (document.getElementById('modulo').value) {
            ...
            case "10004":
                ...
                scale = 0.18;
                break;
            case "10005": // Actividades Comerciales
                icono = "images/comercio.png";
                scale = 0.18;
                break;
            case "10006": // Comercio Internacional
                icono = "images/comercio.png";
                scale = 0.18;
                break;
            case "10007": // Gestion de Ventas
                    icono = "images/comercio.png";
                    scale = 0.18;
                    break;  
            case "10008": // Marketing y Plublicidad
                    icono = "images/marketing.png";
                    scale = 0.18;
                    break;   
            case "10009": // Transporte y Logística
                    icono = "images/comercio.png";
                    scale = 0.18;
                    break; 
            case "10010": // Administración y Finanzas
                    icono = "images/otro.png";
                    scale = 0.18;
                    break; 
            case "10011": // Asistente a la Dirección
                    icono = "images/otro.png";
                    scale = 0.18;
                    break;   
            case "10012": // Gestión administrativa
                    icono = "images/otro.png";
                    scale = 0.18;
                    break;                 
